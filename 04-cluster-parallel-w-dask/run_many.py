...
if __name__ == '__main__':
    ...
    client = dask.distributed.Client(threads_per_worker = 1, n_workers = os.environ.get('SLURM_NTASKS', len(gammas))) ## If we don't have as many cores as we have tasks this initializes a Client with the right number of cores to get the largest client we can get
    for gamma in gammas:
